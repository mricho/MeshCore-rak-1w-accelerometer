...
void CommonCLI::loadPrefsInt(FILESYSTEM* fs, const char* filename) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs->accel_ref_x, sizeof(_prefs->accel_ref_x));                      // 293
    file.read((uint8_t *)&_prefs->accel_ref_y, sizeof(_prefs->accel_ref_y));                      // 297
    file.read((uint8_t *)&_prefs->accel_ref_z, sizeof(_prefs->accel_ref_z));                      // 301
    // next: 305
...
void CommonCLI::savePrefs(FILESYSTEM* fs) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs->accel_ref_x, sizeof(_prefs->accel_ref_x));                      // 293
    file.write((uint8_t *)&_prefs->accel_ref_y, sizeof(_prefs->accel_ref_y));                      // 297
    file.write((uint8_t *)&_prefs->accel_ref_z, sizeof(_prefs->accel_ref_z));                      // 301
    // next: 305
