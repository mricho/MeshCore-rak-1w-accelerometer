# RAK12032 Accelerometer Orientation (RAK3401 1W Repeater)

This fork adds 3-axis accelerometer support to the MeshCore **RAK3401 1W** repeater so you
can tell how the node is sitting — and detect if it has been knocked over — straight from the
**Repeater Admin** console in the MeshCore app (or over USB serial).

![sensor list showing accel_x/y/z and orientation in the Repeater Admin console](images/rak12032-orientation-cli.jpg)
